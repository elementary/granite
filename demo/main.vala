...
public class Granite.Demo : Granite.Application {
    ...
    /**
     * Sidebar item. It stores the number of the corresponding page in the notebook widget.
     */
    private class SidebarItem : Granite.Widgets.Sidebar.Item {
    ...
    public override void activate () {
        ...
        sidebar.item_selected.connect ( (item) => {
            var sidebar_item = item as SidebarItem;
