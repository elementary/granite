...
namespace Granite.Widgets {
    public class AboutDialog : Granite.GtkPatch.AboutDialog
    {
        ...
        public AboutDialog()
        {
            ...
            //help_button.set_size_request (25, 25);
            help_button.size_allocate.connect ( (new_allocation) => {
                // FIXME: The widget is not redrawn immediately
                help_button.set_size_request (new_allocation.height, -1);
            });
