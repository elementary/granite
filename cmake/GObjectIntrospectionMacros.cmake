...
macro(gir_add_introspections introspections_girs)
  ...
  foreach(gir IN LISTS ${introspections_girs})
    ...
    add_custom_command(
      COMMAND ${INTROSPECTION_SCANNER}
              ...
              ${${_gir_name}_CFLAGS}
              ${${_gir_name}_FILES}
              --output ${CMAKE_CURRENT_SOURCE_DIR}/${gir}
    ...
    install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/${gir} DESTINATION share/gir-1.0)
    ...
    add_custom_command(
      COMMAND ${INTROSPECTION_COMPILER}
              ...
              --includedir=.
              ${CMAKE_CURRENT_SOURCE_DIR}/${gir}
              -o ${CMAKE_CURRENT_BINARY_DIR}/${_typelib}
              DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${gir}
      OUTPUT ${_typelib}
  ...
  add_custom_target(gir-girs DEPENDS ${_gir_girs})
